let g:airline#themes#myairline#palette = {}

function! airline#themes#myairline#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  ...
  let s:base02  = {'t': s:ansi_colors ? '0' : (s:tty ? '0' : 234), 'g': '#073642'} " f3 bg
  let s:base01  = {'t': s:ansi_colors ?  10 : (s:tty ? '0' : 240), 'g': '#586e75'} " f3 fg
  let s:base00  = {'t': s:ansi_colors ?  11 : (s:tty ? '7' : 236), 'g': '#657b83'} " f2 bg
  let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '7' : 244), 'g': '#839496'}
  let s:base1   = {'t': s:ansi_colors ?  14 : (s:tty ? '7' : 240), 'g': '#93a1a1'} " f1 bg
  let s:base2   = {'t': s:ansi_colors ?   7 : (s:tty ? '7' : 245), 'g': '#eee8d5'} " f2 fg
  let s:base3   = {'t': s:ansi_colors ?  15 : (s:tty ? '7' : 249), 'g': '#fdf6e3'} " f1 fg
  let s:yellow  = {'t': s:ansi_colors ?   3 : (s:tty ? '3' : 130), 'g': '#b58900'} " f1 bg i
  let s:orange  = {'t': s:ansi_colors ?   9 : (s:tty ? '1' : 166), 'g': '#cb4b16'}
  let s:red     = {'t': s:ansi_colors ?   1 : (s:tty ? '1' : 131), 'g': '#dc322f'} " f1 bg r
  let s:magenta = {'t': s:ansi_colors ?   5 : (s:tty ? '5' : 90 ), 'g': '#d33682'} " f1 bg v
  ...
  " Inactive, according to VertSplit in myairline
  ...
  let g:airline#themes#myairline#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#myairline#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#myairline#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#myairline#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#myairline#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#myairline#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#myairline#palette.normal_modified.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#myairline#palette.insert.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#myairline#palette.insert_modified.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#myairline#palette.visual.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#myairline#palette.visual_modified.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#myairline#palette.replace.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#myairline#palette.replace_modified.airline_warning =
        \ g:airline#themes#myairline#palette.normal.airline_warning

  let g:airline#themes#myairline#palette.tabline = {}

  let g:airline#themes#myairline#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]
